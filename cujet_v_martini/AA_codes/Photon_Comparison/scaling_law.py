...
plt.rcParams.update(helper.my_rcParams)

## Read in the charged hadron multiplicity file
ch_mult = read_csv('ch_mult_copy.csv')
...
ax1.legend(loc='upper left', handles=handles, bbox_to_anchor=(1.,0.8))
ax1.set_yscale('log')
ax1.set_xscale('log')
