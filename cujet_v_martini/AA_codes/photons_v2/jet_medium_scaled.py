...
mult_PbPb_5p02 = {'00-10': 0.5*(1762+1380), '10-20':1234}
...
pT_PBPB_5p02 = PbPb_2p76_spec['martini']['00-10']['pT']
pT_PBPB_2p76 = PbPb_2p76_spec['martini']['00-10']['pT']
...
spec1 = PbPb_2p76_spec['martini']['00-10']['conv']*(5020./2760.)
spec2 = PbPb_2p76_spec['cujet']['00-10']  ['conv']*(5020./2760.)
spec3 = PbPb_2p76_spec['martini']['00-10']['brem']*(5020./2760.)
spec4 = PbPb_2p76_spec['cujet']['00-10']  ['brem']*(5020./2760.)
print('PbPb:',f'{sum((spec1+spec3)/(spec2+spec4))/len(spec1):0.3f}')
print("Conversion Ratios: ", f'{sum(spec1/spec2)/len(spec1):0.3f}')
print("Brem. Ratios: ", f'{sum(spec3/spec4)/len(spec3):0.3f}')
print("Au-Au @ 200 AGeV:")
spec1 = AuAu_spec['martini']['00-10']['conv']*(5020./200.)
spec2 = AuAu_spec['cujet']['00-10']  ['conv']*(5020./200.)
spec3 = AuAu_spec['martini']['00-10']['brem']*(5020./200.)
spec4 = AuAu_spec['cujet']['00-10']  ['brem']*(5020./200.)
print('AuAu:',f'{sum((spec1+spec3)/(spec2+spec4))/len(spec1):0.3f}')
print("Conversion Ratios: ", f'{sum(spec1/spec2)/len(spec1):0.3f}')
print("Brem. Ratios: ", f'{sum(spec3/spec4)/len(spec3):0.3f}')

power = float(sys.argv[1])
fac1 = (5020./2760.)**power
fac2 = (5020./200.)**power
...
for eloss in ['cujet','martini']:
    ...
    ax.plot(pT_PBPB_5p02, spec, color=color, linestyle=lstyle)
    lstyle = 'dashed'
    spec = PbPb_2p76_spec[eloss]['00-10']['brem'] * fac1
    ax.plot(pT_PBPB_2p76, spec, color=color, linestyle=lstyle)
    lstyle='dotted'
    spec = AuAu_spec[eloss]['00-10']['brem'] * fac2
    ...
    ax.plot(pT_PBPB_5p02, spec, color=color, linestyle=lstyle)
    lstyle = 'dashed'
    spec = PbPb_2p76_spec[eloss]['00-10']['conv']*fac1
    ax.plot(pT_PBPB_2p76, spec, color=color, linestyle=lstyle)
    lstyle='dotted'
    spec = AuAu_spec[eloss]['00-10']['conv']*fac2
    ax.plot(pT_AUAU, spec, color=color, linestyle=lstyle)
