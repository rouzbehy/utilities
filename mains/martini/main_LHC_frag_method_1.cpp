...
int main(int argc, char* argv[]){
    ...
    while( event_counter < numEvents ){
        ...
        if (not is_fit_run){
            ...
            cluster_prep_partonic(plist, success_partonic_pseudojets, RECOIL);
        ...
        cluster_prep_inclusive(recoilEvent, forFJ);//forFJ contains recoil & hard hadrons
        ...
        for (size_t ir = 0; ir < num_jet_radii; ir++){
            ...
            if (ir == 1){
                ...
                cluster_prep_inclusive_wth_trk_cut(recoilEvent, forFJ_wcut, trk_cut_shape);
